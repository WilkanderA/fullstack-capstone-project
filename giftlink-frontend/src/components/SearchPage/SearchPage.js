                ...
                <div className="col-md-6">
                    <div className="filter-section mb-3 p-3 border rounded">
                        ...
                        <div className="d-flex flex-column">
                            ...
                            <select id="categorySelect" className="form-control my-1 dropdown-filter">
                            ...
                            <select id="conditionSelect" className="form-control my-1 dropdown-filter">
                                <option value="">All</option>
                    ...
                    <div className="search-results mt-4">
                        ...
                        <div key={product.id} className="card mb-3 search-results-card">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text"><small className="text-muted">Condition: {product.condition}</small></p>
                            </div>
